...
class Atoms(zntrack.Field):
    ...
    def save(self, instance: zntrack.Node):
        ...
        db.add(
            znh5md.io.AtomsReader(atoms, frames_per_chunk=100000, use_pbc_group=True)
        )
